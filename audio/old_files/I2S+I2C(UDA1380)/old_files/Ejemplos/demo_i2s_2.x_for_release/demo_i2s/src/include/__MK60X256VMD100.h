...
#define SDHC_WML_WRBRSTSIZE_MASK                  0x1F000000u
#define SDHC_WML_WRBRSTSIZE_SHIFT                 24
#define SDHC_WML_WRBRSTSIZE(x)                    (((uint32_t)(((uint32_t)(x))<<SDHC_WML_WRBRSTSIZE_SHIFT))&SDHC_WML_WRBRSTSIZE_MASK)
/* FEVT Bit Fields */
...
/* TL7816 Bit Fields */
#define UART_TL7816_TSIZE_MASK                    0xFFu
#define UART_TL7816_TSIZE_SHIFT                   0
#define UART_TL7816_TSIZE(x)                      (((uint8_t)(((uint8_t)(x))<<UART_TL7816_TSIZE_SHIFT))&UART_TL7816_TSIZE_MASK)
...
#define USB_INTEN_STALSIZE_MASK                   0x80u
#define USB_INTEN_STALSIZE_SHIFT                  7
/* ERRSTAT Bit Fields */
