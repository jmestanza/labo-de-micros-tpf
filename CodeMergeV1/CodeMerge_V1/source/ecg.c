...
void ecg_init(void (*funcallback)(void))
{
	...
	PIT_StartTimer(PIT_1_PERIPHERAL,PIT_CH);
...
void ADC0_IRQHANDLER(void) {
  /*  Place your code here */
	...
	if(sample_ptr == ECG_VALUES)
		...
		if(pingpong)
		{
			ecgValues[sample_ptr]= ADC16_GetChannelConversionValue(ADC0_PERIPHERAL, ADC_CH);
		}
		else
		{
			ecgValues1[sample_ptr]= ADC16_GetChannelConversionValue(ADC0_PERIPHERAL, ADC_CH);
		}
		sample_ptr++;
